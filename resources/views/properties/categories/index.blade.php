...
@section('content')
    @include('partials.breadcrumbs', [
        ...
        'btn_text' => __('Add New'),
        'btn_link' => route('properties.categories.create'),
    ])
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        <div id="kt_app_content_container" class="app-container container-fluid">
            ...
            <div class="alert alert-info alert-dismissible" role="alert">
                {{ __('These categories will be shown on property like rented, townhouse etc') }}
            </div>
                                        ...
                                        <td class="">
                                            <div class="d-flex gap-3">
                                                <div class="symbol symbol-circle symbol-30px cursor-pointer">
                                                    <a href="{{ route('properties.categories.edit', $category) }}"
                                            ...
                                            <form id="category-{{ $category->id }}"
                                                action="{{ route('properties.categories.destroy', $category) }}"
                                                method="POST">
                                                @csrf
                                                @method('delete')
                                            </form>
