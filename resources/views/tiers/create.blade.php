        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
            ...
            <div class="card shadow mb-4">
                <div class="card-header card-header-height d-flex align-items-center">
                    <h6 class="font-weight-bold text-primary mb-0 pb-0">{{ __('Add New Investment Plan') }}</h6>
                </div>
                    ...
                    <form method="POST" action="{{ route('tiers.store') }}">
                        ...
                        <div class="form-group mb-6">
                            ...
                            <input type="text"
                                ...
                                placeholder="{{ __('Investment Plan Name') }}" name="name" value="{{ old('name') }}"
                                required>
                            @error('name')
                        ...
                        <div class="form-group mb-6">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input type="text" name="starting"
                                    ...
                                    placeholder="{{ __('Investment Plan Starting Price') }}" value="{{ old('starting') }}"
                                    required />
                            </div>
                            @error('starting')
                                <span class="text-danger">{{ $message }}</span>
                        ...
                        <div class="form-group mb-6">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input type="text"
                                    ...
                                    name="referral_reward" value="{{ old('referral_reward') }}" required>
                            </div>
                        ...
                        {{-- Plan Specifications --}}
                        @livewire('plan.specifications', ['specifications' => []])

                        <!--begin::Actions-->
                        <div class="text-center py-10">
                            <button type="submit" class="btn btn-primary">
                                <span class="indicator-label">{{ __('Create Investment Plan') }}</span>
                            </button>
                        </div>
                        <!--end::Actions-->
                    </form>
