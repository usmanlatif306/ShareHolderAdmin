 <!--begin::Form-->
 <form id="kt_modal_add_country_form" class="form" wire:submit="addCountry" method="POST">
     @csrf
     <!--begin::Scroll-->
     <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_country_scroll" data-kt-scroll="true"
         ...
         <div class="fv-row mb-7">
             ...
             <input type="text" name="name" wire:model="name"
                 ...
                 placeholder="{{ __('Country Name') }}" autofocus />
             @error('name')
     ...
     <div class="text-center pt-10">
         ...
         <button type="submit" class="btn btn-primary" data-kt-users-modal-action="submit">
             <span class="indicator-label">{{ __('Create Country') }}</span>
         </button>
     </div>
     <!--end::Actions-->
 </form>
