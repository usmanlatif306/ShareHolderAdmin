        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
            ...
            <div class="card shadow mb-4">
                <div class="card-header card-header-height d-flex align-items-center">
                    <h6 class="font-weight-bold text-primary mb-0 pb-0">{{ __('Add Glossary') }}</h6>
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route('glossaries.store') }}">
                        @csrf
                        ...
                        <div class="form-group mb-6">
                            ...
                            <input type="text"
                                ...
                                placeholder="{{ __('Word') }}" name="word" value="{{ old('word') }}" required>
                            @error('word')
                        ...
                        <div class="form-group mb-6">
                            ...
                            <textarea class="form-control form-control-solid @error('explanation') is-invalid @enderror" id="explanation"
                                name="explanation" placeholder="{{ __('Explanation') }}" rows="5">{{ old('explanation') }}</textarea>
                        ...
                        <div class="text-center py-10">
                            <button type="submit" class="btn btn-primary">
                                <span class="indicator-label">{{ __('Create Glossary') }}</span>
                            </button>
                        </div>
                        <!--end::Actions-->
                    </form>
